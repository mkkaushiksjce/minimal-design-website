...
var lessConfig = {
    files: [
        ...
        WORKPATH + 'common/css_libraries/lesshat.less',
        WORKPATH + 'common/css_libraries/normalize.less',
        WORKPATH + 'common/css_libraries/slick.less',
        WORKPATH + 'common/css_libraries/slick-theme.less',
        WORKPATH + 'common/css_libraries/owl.carousel.less',
        WORKPATH + 'common/css_libraries/owl.theme.default.less',
        WORKPATH + 'common/css_libraries/slick.less',
        WORKPATH + 'common/css_libraries/slick-theme.less',

        WORKPATH + 'less/variables.less',
...
var scriptLibraryConfig = {
    files: [
        ...
        WORKPATH + "common/js_libraries/slick.js",
        WORKPATH + "common/js_libraries/owl.carousel.js",
    ],
    dest: "js",
    destFile: "libs.js"
};
